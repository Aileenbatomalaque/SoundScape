...
const Melan = () => {
  return (
    <View className="bg-[#6a6cf1] flex-1 items-center justify-start">
      <View className="flex-row w-full justify-between items-center h-10 mt-10">
        
      <Link href="/home"><Image className="ml-2 opacity-50 -rotate-90" source={require('../assets/back.png')} style={{ width: 24, height: 24 }} /></Link>
      <Text className="text-lg font-light">Melancholic Music</Text>
      <Image className="mr-2 opacity-50"  source={require('../assets/3.png')} style={{ width: 24, height: 24 }} />
      </View>
      <Text className="text-2xl mt-10 text-gray-700">Lay Me Down</Text>
      <Text className="text-lg mt-5 text-gray-500">Sam Smith</Text>
      <Image className="mt-10" source={require('../assets/lay.jpg')} style={{ width: 300, height: 300,borderRadius:155, borderWidth:5, borderColor:'white' }} />
