  ...
  return (
    <View className="flex-1 bg-[#F3D9E9] p-4">
      <View className="flex-row items-center justify-between mb-4">
        <Image source={require('../../assets/pfp.png')} style={{ width: 60, height: 60, borderRadius: 30 }} />
      ...
      <View className="flex-row justify-between mb-4 p-2 bg-white rounded-lg shadow-lg">
        <Image source={require('../../assets/album1.jpg')} style={{ width: 100, height: 100, borderRadius: 8 }} />
        ...
        <TouchableOpacity activeOpacity={0.7}>
          <Image source={require('../../assets/x.png')} style={{ width: 24, height: 24 }} />
        </TouchableOpacity>
      </View>

      <View className="flex-row justify-between mb-4 p-2 bg-white rounded-lg shadow-lg">
        <Image source={require('../../assets/album2.jpg')} style={{ width: 100, height: 100, borderRadius: 8 }} />
        <View className="flex-1 ml-4">
      ...
      <View className="flex-row justify-between mb-4 p-2 bg-white rounded-lg shadow-lg">
        <Image source={require('../../assets/lover.jpg')} style={{ width: 100, height: 100, borderRadius: 8 }} />
        <View className="flex-1 ml-4">
