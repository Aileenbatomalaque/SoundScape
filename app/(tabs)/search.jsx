    ...
    <View className="flex-1 bg-[#F3D9E9] p-4">
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-row items-center mb-4 p-3 bg-white rounded-lg shadow-lg">
          <Image source={require('../../assets/week.jpg')} style={{ width: 60, height: 60, borderRadius: 8, marginRight: 10 }} />
          <View style={{ flex: 1 }}>
            <Text className="text-lg font-semibold text-gray-800">The Weekend</Text>
            <Text className="text-sm text-gray-500">Starboy</Text>
          </View>
          <TouchableOpacity>
            <Image source={require('../../assets/pay.png')} style={{ width: 30, height: 30 }} />
          </TouchableOpacity>
        </View>

        {/* Recent Search 2 */}
        <View className="flex-row items-center mb-4 p-3 bg-white rounded-lg shadow-lg">
          <Image source={require('../../assets/sza.jpg')} style={{ width: 60, height: 60, borderRadius: 8, marginRight: 10 }} />
          <View style={{ flex: 1 }}>
        ...
        {/* Recent Search 3 */}
        <View className="flex-row items-center mb-4 p-3 bg-white rounded-lg shadow-lg">
          <Image source={require('../../assets/artist3.jpg')} style={{ width: 60, height: 60, borderRadius: 8, marginRight: 10 }} />
          <View style={{ flex: 1 }}>
        ...
        {/* Recommended Song 1 */}
        <View className="flex-row items-center mb-4 p-3 bg-white rounded-lg shadow-lg">
          <Image source={require('../../assets/sza.jpg')} style={{ width: 60, height: 60, borderRadius: 30, marginRight: 10 }} />
          <View style={{ flex: 1 }}>
            <Text className="text-lg font-semibold text-gray-800">SZA</Text>
        ...
        {/* Recommended Song 2 */}
        <View className="flex-row items-center mb-4 p-3 bg-white rounded-lg shadow-lg">
          <Image source={require('../../assets/taylor.jpg')} style={{ width: 60, height: 60, borderRadius: 30, marginRight: 10 }} />
          <View style={{ flex: 1 }}>
            <Text className="text-lg font-semibold text-gray-800">Taylor Swift</Text>
        ...
        {/* Recommended Song 3 */}
        <View className="flex-row items-center mb-4 p-3 bg-white rounded-lg shadow-lg">
          <Image source={require('../../assets/week.jpg')} style={{ width: 60, height: 60, borderRadius: 30, marginRight: 10 }} />
          <View style={{ flex: 1 }}>
            <Text className="text-lg font-semibold text-gray-800">The Weekend</Text>
        ...
        {/* Recommended Song 4 */}
        <View className="flex-row items-center mb-4 p-3 bg-white rounded-lg shadow-lg">
          <Image source={require('../../assets/katy.jpg')} style={{ width: 60, height: 60, borderRadius: 30, marginRight: 10 }} />
          <View style={{ flex: 1 }}>
        ...
        {/* Recommended Song 5 */}
        <View className="flex-row items-center mb-4 p-3 bg-white rounded-lg shadow-lg">
          <Image source={require('../../assets/chris.jpg')} style={{ width: 60, height: 60, borderRadius: 30, marginRight: 10 }} />
          <View style={{ flex: 1 }}>
